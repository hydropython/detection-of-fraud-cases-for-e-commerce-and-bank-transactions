...
class FraudModelingPipeline:
    ...
    def shap_analysis(self):
        ...
        shap_img_path = '../Images/shap_summary_plott.png'
        ...
        expected_value = explainer.expected_value  # Get the expected value
        force_plot = shap.force_plot(expected_value, shap_values, self.X_test.iloc[0,:], matplotlib=False)
        shap_force_plot_html = '../Images/shap_force_plott.html'
        ...
        shap.force_plot(expected_value, shap_values, self.X_test.iloc[0,:], matplotlib=True)
        plt.savefig("../Images/shap_force_plot_static.png")
        mlflow.log_artifact("../Images/shap_force_plot_staticc.png")
        os.remove("../Images/shap_force_plot_staticc.png")
    def lime_analysis(self):
        ...
        i = 0  # Change this index to analyze different instances
        exp = lime_explainer.explain_instance(data_row=self.X_test.iloc[i], predict_fn=self.gb_best_model.predict_proba)

        # Specify the path for the LIME explanation HTML file
        lime_img_path = '../Images/lime_explanation.html'  # Save to ../Images
